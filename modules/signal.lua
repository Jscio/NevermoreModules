...
if not getgenv().NVRMR then
    loadstring(game:HttpGet("https://github.com/Jscio/NevermoreModules/raw/refs/heads/main/loader.lua"))()
end

local EventHandlerUtils = getgenv().NVRMR_REQUIRE("event-handler-utils")
